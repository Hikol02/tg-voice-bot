...
content = content.replace('bash ./models/download-ggml-model.sh base\ncd "$INSTALL_DIR"\npython3 -m venv venv', 'bash ./models/download-ggml-model.sh base\ncd "$INSTALL_DIR"\n' + new_proxy_block + 'python3 -m venv venv')
